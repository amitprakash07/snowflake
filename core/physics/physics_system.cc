...
void Engine::Physics::PhysicsSystem::InitializePhysicsSystem(
  ...
  if (mPhysicsSystem.isNull()) {
    ...
    SharedPointer<Graphics::Line> ab = Graphics::Line::AddLine(
        Engine::Math::Vector3(0, 0, 0), Engine::Math::Vector3(0, 0, 0),
...
Engine::Physics::PhysicsSystem::PhysicsSystem() { showCollisionMesh = false; }
...
Engine::SharedPointer<Engine::Physics::PhysicsSystem>
Engine::Physics::PhysicsSystem::GetPhysicsSystem() {
  return mPhysicsSystem;
}

bool Engine::Physics::PhysicsSystem::CheckCollision(Ray iRay,
...
bool Engine::Physics::PhysicsSystem::CheckCollision(Math::Vector3 startPoint,
...
bool Engine::Physics::PhysicsSystem::IntersectTriangle(
