...
template <typename T>
void Engine::Utils::Sort::MergeSort(T* o_List, int iListlength,
...
template <typename T>
void Engine::Utils::Sort::InternalMergeSort(T* o_list, unsigned int iStart,
                                            unsigned int iEnd,
...
template <typename T>
void Engine::Utils::Sort::Merge(T* o_list, unsigned int start,
...
template <typename T>
void Engine::Utils::Sort::QuickSort(T* o_list, int iListlength,
                                    int (*SortFunc)(T i_A, T i_B)) {}
