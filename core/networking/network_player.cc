...
Engine::Networking::NetworkPlayer::CreateNetworkPlayer(
    ...
    Math::Transform clientPlayerTransform, Engine::Graphics::RGBAColor iColor) {
...
void Engine::Networking::NetworkPlayer::SendNetworkPlayerUpdates(
...
void Engine::Networking::NetworkPlayer::SetControlPlayer(
