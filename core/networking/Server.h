...
class Server {
 public:
  ...
  void addToNetworkPlayerList(SharedPointer<MeshObject> IObject,
  ...
  SharedPointer<NetworkPlayer> InstantiateNetworkPlayer(
      RakNet::NetworkID iNetowrkID, std::string i_meshFileName,
  ...
  SharedPointer<NetworkPlayer> GetNetworkPlayer(RakNet::NetworkID i_networkID);
