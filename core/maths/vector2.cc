...
// Addition
Engine::Math::Vector2 Engine::Math::Vector2::operator+(
...
Engine::Math::Vector2 operator*(const float i_lhs,
                                const Engine::Math::Vector2& i_rhs) {
  return i_rhs * i_lhs;
}
...
Engine::Math::Vector2 Engine::Math::Cross(const Vector2& i_lhs,
                                          const Vector2& i_rhs) {
...
Engine::Math::Vector2::Vector2(const float i_x, const float i_y,
                               const float i_z)
    : x(i_x), y(i_y) {}
