...
// Addition
Engine::Math::Vector4 Engine::Math::Vector4::operator+(
...
Engine::Math::Vector4 operator*(const float i_lhs,
                                const Engine::Math::Vector4& i_rhs) {
  return i_rhs * i_lhs;
}
...
Engine::Math::Vector4::Vector4(const float i_x, const float i_y,
