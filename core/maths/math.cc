...
Engine::Math::Vector3 Engine::Math::Plane::ClosestPointFromPointOnPlane(
...
float Engine::Math::Plane::getDistanceFromOrigin() const { return distance; }

Engine::Math::Plane Engine::Math::Plane::ComputePlane(Vector3 iA, Vector3 iB,
                                                      Vector3 iC) {
  Plane p;
...
void Engine::Math::ClosestPointFromPointOnLineSegment(Vector3 c, Vector3 a,
                                                      Vector3 b, float &t,
                                                      Vector3 &d) {
  Vector3 ab = b - a;
