...
Engine::Math::Matrix4x4 Engine::Math::Matrix4x4::CreateLookAtMatrix(
...
Engine::Math::Matrix4x4 Engine::Math::Matrix4x4::operator*(
    Matrix4x4 m_2) const {
  /*
...
Engine::Math::Vector3 Engine::Math::Matrix4x4::mul(Vector3 vector,
                                                   bool isVector) const {
...
void Engine::Math::Matrix4x4::inverse() { *this = this->getInverse(); }
...
void Engine::Math::Matrix4x4::transpose() { *this = this->getTranspose(); }

Engine::Math::Matrix4x4::Matrix4x4(const Quaternion& i_rotation,
...
Engine::Math::Matrix4x4::Matrix4x4(const Vector3& i_translation,
                                   bool direction) {
  m_00 = 1.0f;
  m_01 = 0.0f;
  m_02 = 0.0f;
