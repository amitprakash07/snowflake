...
Engine::Math::Quaternion Engine::Math::Quaternion::slerp(
...
// Getters
float Engine::Math::Quaternion::w() const { return mW; }

float Engine::Math::Quaternion::x() const { return mX; }

float Engine::Math::Quaternion::y() const { return mY; }

float Engine::Math::Quaternion::z() const { return mZ; }

// Cross Product
Engine::Math::Quaternion Engine::Math::Quaternion::operator*(
...
// Cross Product
Engine::Math::Quaternion Engine::Math::Quaternion::cross(
    const Quaternion& i_rhs) const {
  /*
  q1 = [s1, v1]
  q2 = [s2, v2]
...
Engine::Math::Quaternion Engine::Math::Quaternion::angularDisplacement(
...
Engine::Math::Quaternion::Quaternion(const float i_angleInRadians,
...
Engine::Math::Quaternion::Quaternion(const float i_mW, const float i_mX,
