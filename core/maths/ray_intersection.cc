...
bool Engine::Physics::Ray::InstersectSphere(Math::Sphere sphere,
...
bool Engine::Physics::Ray::IntersectBox(BoundingBox box,
                                        HitInfo& iHitInfo) const {
...
bool Engine::Physics::Ray::IntersectPlane(Math::Plane iPlane,
                                          HitInfo& iHitInfo) const {
...
bool Engine::Physics::Ray::IntersectTriangle(
