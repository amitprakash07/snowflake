...
std::map<std::string, Engine::SharedPointer<Engine::Scene>>
    Engine::Scene::mSceneList;
...
Engine::SharedPointer<Engine::Scene> Engine::Scene::CreateNewScene(
    std::string i_sceneName) {
  if (!i_sceneName.empty()) {
    SharedPointer<Engine::Scene> temp =
        SharedPointer<Engine::Scene>(new Scene(i_sceneName), "Engine::Scene");
...
void Engine::Scene::SetNewFrame(bool newFrame) { isNextFrame = newFrame; }

bool Engine::Scene::IsNewFrame() const { return isNextFrame; }
...
bool Engine::Scene::sortMeshObject(SharedPointer<MeshObject> i_gameObjectOne,
...
Engine::SharedPointer<Engine::Scene> Engine::Scene::getScene(
    std::string i_sceneName) {
...
Engine::SharedPointer<Engine::Camera> Engine::Scene::findCamera(
...
void Engine::Scene::setObjectController(
...
bool Engine::Scene::isCollidable() { return false; }

bool Engine::Scene::isPhysicsEnabled() { return false; }
...
bool Engine::Scene::receivingShadowEnabled() { return false; }

void Engine::Scene::castShadow(bool, Graphics::ShadowMethod) {
  // Stub
}

bool Engine::Scene::castingShadowEnabled() { return false; }

Engine::ObjectType Engine::Scene::getObjectType() { return mObjectType; }
