...
void Engine::Debug::DebugMenu::HandleMessage(
  ...
  if (!i_MessageSender.isNull()) {
    if (!i_MessageSender.isNull() &&
        Engine::utils::StringHash("DebugMenuHandler") == i_message &&
...
void Engine::Debug::DebugMenu::Activate(bool iRequest) {
  ...
  for (std::map<int, Engine::SharedPointer<Engine::UI::UIElement>>::iterator i =
...
void Engine::Debug::DebugMenu::CreateButton(
...
void Engine::Debug::DebugMenu::CreateCheckBox(
...
void Engine::Debug::DebugMenu::CreateSlider(
...
void Engine::Debug::DebugMenu::CreateText(
...
bool Engine::Debug::DebugMenu::isActivated() const { return isActive; }
...
void Engine::Debug::DebugMenu::setObjectController(
