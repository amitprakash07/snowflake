...
std::map<Engine::ShapeTarget,
         std::map<std::string, Engine::SharedPointer<Engine::Object>>>
...
Engine::Debug::DebugShapes::DrawShape(std::string iName,
  ...
  return Engine::Graphics::Line::AddLine(iStartPoint, iEndPoint, color);
}

// Sphere
Engine::SharedPointer<Engine::MeshObject> Engine::Debug::DebugShapes::DrawShape(
    std::string iName, ShapeTarget iShapeType, Engine::Math::Vector3 iCenter,
    float iRadius, Engine::Graphics::RGBColor iColor) {
...
// Box
Engine::SharedPointer<Engine::MeshObject> Engine::Debug::DebugShapes::DrawShape(
    std::string iName, ShapeTarget iShapeType, Engine::Math::Vector3 i_position,
  ...
  Engine::SharedPointer<Engine::MeshObject> debugBox =
      Engine::MeshObject::CreateMeshObject(
...
Engine::SharedPointer<Engine::MeshObject> Engine::Debug::DebugShapes::DrawShape(
    std::string iName, ShapeTarget iShapeType, Engine::Math::Vector3 i_position,
    float iRadius, float iHeight, Engine::Graphics::RGBColor iColor) {
