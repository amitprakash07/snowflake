...
MessagingSystem::getMessagingSystem() {
  if (mMessagingSystem.isNull()) {
    ...
    SharedPointer<MessagingSystem> temp(SharedPointer<MessagingSystem>(
        new MessagingSystem(), "MessagingSystem"));
...
void MessagingSystem::addMessageHandler(
    utils::StringHash& i_message,
...
void MessagingSystem::sendMessage(utils::StringHash& i_message,
...
bool MessagingSystem::removeMessageHandler(
    utils::StringHash& i_message,
