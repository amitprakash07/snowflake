...
macro(revert_target_folder)
    set(PROJECT_TARGET_VS_SOLUTION_FOLDER ${PROJECT_TARGET_VS_SOLUTION_FOLDER_SCOPED} PARENT_SCOPE)
    set(PROJECT_TARGET_VS_SOLUTION_FOLDER_SCOPED "" )
endmacro()

macro(append_src_group_folder group_name)
    set(PROJECT_TARGET_VS_SOURCE_GROUP_FILTER_SCOPED ${PROJECT_TARGET_VS_SOURCE_GROUP_FILTER})
    set(PROJECT_TARGET_VS_SOURCE_GROUP_FILTER ${PROJECT_TARGET_VS_SOURCE_GROUP_FILTER}/${group_name} PARENT_SCOPE)
endmacro()

macro(revert_src_group_folder)
    set(PROJECT_TARGET_VS_SOURCE_GROUP_FILTER ${PROJECT_TARGET_VS_SOURCE_GROUP_FILTER_SCOPED} PARENT_SCOPE)
    set(PROJECT_TARGET_VS_SOURCE_GROUP_FILTER_SCOPED "")
endmacro()
